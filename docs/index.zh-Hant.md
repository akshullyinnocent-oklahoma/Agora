...
- **[網頁搜尋](web-search.md)** — Brave、Serper、Tavily、SearXNG 整合
...
- **[資料可攜性](import-export.md)** — 匯出/匯入 .agora 檔案、從 Claude 和 ChatGPT 匯入
- **[語言](language.md)** — 在英文、中文或系統預設值之間切換
...
- **預設代理**：多輪工具呼叫，支援網頁搜尋、Shell 執行、檔案操作與記憶體
