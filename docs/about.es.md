...
Versión de la aplicación, actualizaciones, configuración de documentación y enlaces.

## Información de la App

| Campo | Descripción |
|-------|-------------|
| **Desarrollador** | Newo Ether |
| **Versión** | Muestra el nombre de la versión actual y el código de compilación |
...
Controla el **botón de ayuda flotante** (FAB) que aparece en las subpáginas de configuración. Cuando está activado, un botón :material-help-circle: enlaza a la página relevante del manual de usuario.

Desactiva esta opción si prefieres una interfaz más limpia sin el FAB de documentación.
