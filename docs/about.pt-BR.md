...
Versão do aplicativo, atualizações, configurações de documentação e links.

## Informações do App

| Campo | Descrição |
|-------|-----------|
| **Desenvolvedor** | Newo Ether |
| **Versão** | Exibe o nome da versão atual e o código de build |
...
### Mostrar Links da Documentação

Controla o **botão de ajuda flutuante** (FAB) que aparece nas subpáginas de configurações. Quando ativado, um botão :material-help-circle: direciona para a página relevante do manual do usuário.

Desative se preferir uma interface mais limpa sem o FAB de documentação.
