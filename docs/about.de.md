...
App-Version, Updates, Dokumentationseinstellungen und Links.

## App-Info

| Feld | Beschreibung |
|-------|-------------|
| **Entwickler** | Newo Ether |
| **Version** | Zeigt den aktuellen Versionsnamen und Build-Code an |
...
### Dokumentationslinks anzeigen

Steuert den **schwebenden Hilfe-Button** (FAB), der auf Einstellungsunterseiten erscheint. Wenn aktiviert, verlinkt ein :material-help-circle:-Button zur entsprechenden Benutzerhandbuch-Seite.

Deaktivieren Sie dies, wenn Sie eine übersichtlichere Oberfläche ohne den Dokumentations-FAB bevorzugen.
